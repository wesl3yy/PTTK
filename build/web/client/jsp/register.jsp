        ...
        <div class="container flex flex-center">
            <div class="form-login">
                ...
                <form action="register" method="POST">
                    <input class="input-sweet" type="text" name="fullname" placeholder="Họ và tên">
                    ...
                    <input class="input-sweet" type="text" name="address" placeholder="Địa chỉ">
                    <input class="input-sweet" type="text" name="phone-num" placeholder="Số điện thoại">
                    <div class="flex">
